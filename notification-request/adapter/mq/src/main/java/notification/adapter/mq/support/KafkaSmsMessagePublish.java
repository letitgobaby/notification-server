...
public final class KafkaSmsMessagePublish implements KafkaMessagePublishSupport<SmsMessagePayload> {
    ...
    @Override
    public Mono<Void> publish(SmsMessagePayload payload) {
    ...
    private Mono<String> serializeMessage(SmsMessagePayload payload) {
