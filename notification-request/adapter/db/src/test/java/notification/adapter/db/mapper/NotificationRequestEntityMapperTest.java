...
class NotificationRequestEntityMapperTest {
    ...
    void toDomain_shouldConvertEntityToDomainWithAllFields() {
        ...
        assertThat(domain.getContent().title()).isEqualTo("Test Title");
        assertThat(domain.getTemplate().templateId()).isEqualTo("template-1");
    ...
    void toContentEntity_shouldConvertDomainContent() {
        ...
        // When
        NotificationRequestContentEntity entity = mapper.toContentEntity(domain, requestId, contentId);
    ...
    void toTemplateInfoEntity_shouldConvertDomainTemplate() {
        ...
        NotificationRequest domain = createFullNotificationRequest();
        String requestId = "req-1";
        String templateInfoId = "template-info-1";
        ...
        assertThat(entity).isNotNull();
        assertThat(entity.getRequestId()).isEqualTo(requestId);
        assertThat(entity.getTemplateInfoId()).isEqualTo(templateInfoId);
