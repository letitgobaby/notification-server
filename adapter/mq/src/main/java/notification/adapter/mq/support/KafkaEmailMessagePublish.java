...
public final class KafkaEmailMessagePublish implements KafkaMessagePublishSupport<EmailMessagePayload> {
    ...
    @Override
    public Mono<Void> publish(EmailMessagePayload payload) {
    ...
    private Mono<String> serializeMessage(EmailMessagePayload payload) {
